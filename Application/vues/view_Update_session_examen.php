<main class=" bg-light  pt-2 mt-3">
    <h2 class=" text-center">Modifier une session d'examen</h2>
    <form action="index.php" method="GET" class="d-flex flex-column col-5 col-md-4 col-lg-3 container">
        ...
        <input type="hidden" name="action" value="ajoutExamenEffectue">
    </form>
</main>